...
class PolynomialRegressionPage(ttk.Frame):
    def __init__(self, root, send_to, generic_solver):
        ...
        degree_label = ttk.Label(frame_left, text="Degree:")
        degree_label.pack(pady=5, anchor="w")

        self.degree_entry = ttk.Entry(frame_left, width=40)
        ...
        calculate_btn = ttk.Button(frame_left, text="Calculate", bootstyle="primary", command=self.calculate_polynomial)
